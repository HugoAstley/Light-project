...
for(i in 1:5){model_output_all_diagnoses.DOC[[i]] <- lm(ICD_10_code_groups[[i]]$n ~ICD_10_code_groups[[i]]$Mean_of_Sunlight_Duration_minutes +
                                                          ICD_10_code_groups[[i]]$DOC + 
