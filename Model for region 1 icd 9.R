...
for(i in 1:86){model_output_all_diagnoses.DOC[[i]] <- lm(ICD_9_code_groups.REGION1[[i]]$DOC ~ICD_9_code_groups.REGION1[[i]]$mean_sunrise_time+
                                                            ICD_9_code_groups.REGION1[[i]]$X + 
