...
for(i in 1:86){model_output_all_diagnoses.DOC[[i]] <- lm(ICD_9_code_groups[[i]]$DOC ~ICD_9_code_groups[[i]]$ALLSKY_TOA_SW_DWN +
                                                           ICD_9_code_groups[[i]]$KT +
                                                           ICD_9_code_groups[[i]]$KT:ICD_9_code_groups[[i]]$ALLSKY_TOA_SW_DWN+
...
colnames(coefficients.p.values_model_output_all_diagnoses.DOC) <- c("Diagnosis group",
                                                                    "Intercept.pvalue",
                                                                    "Top of atmosphere insolation.pvalue",
                                                                    "Clearness coefficient.pvalue",
                                                                    ...
                                                                    "Top of atmosphere insolation:KT.pvalue",
                                                                    "Intercept",
                                                                    ...
                                                                    "Unkown",
                                                                    "Status not stated",
                                                                    "Top of atmosphere insolation:KT")
...
hide <- sapply(names(coefficients.p.values_model_output_all_diagnoses.DOC[3:45]), function(x) eval(parse(text=sub("_SUB_","`x`","_SUB_ = F"))),
               simplify=F,USE.NAMES=T)


#
format <- sapply(names(coefficients.p.values_model_output_all_diagnoses.DOC)[46:88],function(x)
{
