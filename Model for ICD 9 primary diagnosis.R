...
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$RACE <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$RACE)}
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$OWNER <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$OWNER)}
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$SEX <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$SEX)}
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$ESOP1 <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$ESOP1)}
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$MARSTAT <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$MARSTAT)}
for(i in 1:length(primary.diagnosis.ICD_9_code_groups)){primary.diagnosis.ICD_9_code_groups[[i]]$REGION <- factor(primary.diagnosis.ICD_9_code_groups[[i]]$REGION)}
...
for(i in 1:86){model_output_all_diagnoses.DOC[[i]] <- lm(primary.diagnosis.ICD_9_code_groups[[i]]$DOC ~primary.diagnosis.ICD_9_code_groups[[i]]$Mean_of_Sunlight_Duration_minutes +
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$n + 
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$AGE +
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$SEX + 
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$SVYEAR + 
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$BEDSIZE +
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$REGION+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$PRECTOT+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$AQI+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$PS+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$RH2M+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$T2MWET+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$WS2M+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$OWNER+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$RACE+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$ESOP1+
                                                           primary.diagnosis.ICD_9_code_groups[[i]]$MARSTAT)}
...
coefficients.p.values_model_output_all_diagnoses.DOC <- merge(y= coefficients.p.values_model_output_all_diagnoses.DOC, x= Number.of.observations.primary.diagnosis.ICD_9_groups, by.y="Diagnosis group", by.x= "Diagnosis", all.y= T)
