...
for(i in 1:86){model_output_all_diagnoses.DOC[[i]] <- lm(ICD_9_code_groups[[i]]$n ~ICD_9_code_groups[[i]]$Mean_of_Sunlight_Duration_minutes +
                                                           ICD_9_code_groups[[i]]$DOC+
...
#
format <- sapply(names(coefficients.p.values_model_output_all_diagnoses.DOC)[43:82],function(x)
{
